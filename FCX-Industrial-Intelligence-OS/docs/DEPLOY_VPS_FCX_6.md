...
Obrigatorio trocar todos os placeholders `replace_with_`.
...
JWT_SECRET=replace_with_random_jwt_secret_64_chars_min
OPENAI_API_KEY=
ANTHROPIC_API_KEY=
GOOGLE_API_KEY=
GITHUB_TOKEN=
...
3. Bloqueia deploy se houver placeholders `replace_with_`.
