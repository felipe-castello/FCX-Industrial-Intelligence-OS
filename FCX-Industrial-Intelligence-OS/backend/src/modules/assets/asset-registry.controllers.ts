...
export class SitesController {
  ...
  @Get() findAll(@Query('companyId') companyId?: string, @Query('clientId') clientId?: string) { return this.service.sites(companyId, clientId); }
  ...
  @Put(':id') replace(@Param('id') id: string, @Body() data: UpdateSiteDto) { return this.service.updateSite(id, data); }
